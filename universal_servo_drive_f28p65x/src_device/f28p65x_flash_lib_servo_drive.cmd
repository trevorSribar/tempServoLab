...
MEMORY
{
   ...
   FLASH_BANK0_CODE     : origin = 0x080002, length = 0x10000
   FLASH_BANK0_DATA 	: origin = 0x090002, length = 0x0FFFE
   ...
   GROUP
   {
    .TI.ramfunc
     ...
     dcl32funcs
                              ...
                              ALIGN(8)
    ctrlfuncs            :    LOAD >  FLASH_BANK0_CODE,
                              RUN  >  RAMLS0123,
                              ...
                              ALIGN(8)
    .binit                : >  FLASH_BANK0_DATA,
                              ALIGN(8)
    .cinit                : >  FLASH_BANK0_DATA,
                              ALIGN(8)
    .stack                : >  RAMM0
